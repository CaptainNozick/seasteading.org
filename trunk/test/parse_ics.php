...
//$timeout = 2; // seconds
//$fp = fsockopen($calendar, 80, $errNo, $errString, $timeout); // stops connecting after 2 seconds, and stores the error Number in $errNo and the error String in $errStr  

$ch = curl_init();
$timeout = 5; // set to zero for no timeout
curl_setopt ($ch, CURLOPT_URL, $calendar);
